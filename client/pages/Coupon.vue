            ...
            <div class="coupon-detail result-container">
              <div class="result-media">
                <div class="media">
                  ...
                  <img
                    :src="serverUrl(item.portal.media.url)"
                    v-else-if="item.portal.media && item.portal.media.type == 'image'"
                    alt=""
                  />
              ...
              <div class="result-data">
                <p class="category-strain my-0">
                  <span class="category">{{
                    item.category.price_type == 2 ? 'Flower | ' + item.category.name : item.category.name
                  }}</span>
                ...
                <div class="company-name">
                  <img
                    ...
                    alt
                    v-if="item.portal.store_type == 1 || item.portal.store_type == 3"
                  />
                  <img
                    class="store-type-img"
                    src="/imgs/delivery.png"
                    alt
                    v-if="item.portal.store_type == 2 || item.portal.store_type == 3"
                  />
                  &nbsp;{{ item.portal.name }}
                </div>
    ...
    return {
      ...
      meta: [
        { hid: 'title', name: 'title', content: 'Marijuana Coupons - Weed Coupons' },
        {
          hid: 'keywords',
          name: 'keywords',
          content: 'marijuana, weed, coupons, dispensary, delivery, deals, cannabis',
        },
        {
          hid: 'description',
          name: 'description',
          content:
            'Find your Marijuana Coupons. Dispensaries and Deliveries Selling Cannabis Provide Weed Coupons to Save you Money.',
        },
      ],
    }
  },
