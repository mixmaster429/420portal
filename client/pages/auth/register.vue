          ...
          <form @submit.prevent="register" @keydown="form.onKeydown($event)">
            ...
            <div class="terms-condition mt-5">
              <div class="form-group mb-0 d-flex align-item-center">
                ...
                <label for="age_term" class="ml-1 mb-0" style="color: white; font-size: 16px"
                  >Are you 21+ Years Old or Older?</label
                >
              </div>

              <div class="form-group mb-0 d-flex align-item-center">
                <input type="checkbox" required name="terms" id="user_term" checked />
                <label for="user_term" class="ml-1 mb-0" style="font-size: 16px">Accept</label>
                <a
                  href="javascript:;"
