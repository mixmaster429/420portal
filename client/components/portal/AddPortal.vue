  ...
  <div class="pa_addform col-xl-3 col-lg-4 col-md-6 col-sm-6 mx-auto">
    <div class="pa-logo">
      ...
      <div
        class="progress"
        id="progress_logo"
        style="height: 10px; width: 150px; margin: 10px auto; display: none"
        v-show="uploading"
      >
        <div
    ...
    <form action="" class="pt-3" id="pa_addform" method="post" ref="pa_addform" @submit.prevent="savePortal()">
      ...
      <hr style="border-top: 1px solid white; margin-top: 0.1rem" />
      ...
      <div class="ap_dispensary mt-4" v-show="portal.store_type == 1 || portal.store_type == 3">
        <client-only>
          <div class="floating-label">
            <gmap-autocomplete class="floating-input" @place_changed="updateAddress"></gmap-autocomplete>
      ...
      <div
        class="form-label-group portal_description floating-portal floating-label"
        style="margin-bottom: 12px; margin-top: 35px"
      >
        <textarea
      ...
      <div class="floating-label">
        <input
          ...
          name="facebook_url"
          id="facebook"
          v-model="portal.facebook_url"
          data-value="facebook.com/"
          placeholder="fb"
        />
      ...
      <div class="floating-label">
        <input
          ...
          name="twitter_url"
          id="twitter"
          v-model="portal.twitter_url"
          data-value="twitter.com/"
          placeholder="tw"
        />
      ...
      <div class="floating-label">
        <input
          ...
          name="instagram_url"
          id="instagram"
          v-model="portal.instagram_url"
          data-value="instagram.com/"
          placeholder="is"
        />
      ...
      <div class="floating-label">
        <input
          ...
          name="youtube_url"
          id="youtube"
          v-model="portal.youtube_url"
          data-value="youtube.com/user/"
          placeholder=" "
        />
      ...
      <div class="time-frame">
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="monday_times"
              name="mon_closed"
              @change="openPortal('monday')"
              :checked="portal.mon_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              class="closed_24_hour"
              type="checkbox"
              value="1"
              name="mon_closed"
              id="cmonday_times"
              @change="closePortal('monday')"
              :checked="portal.mon_closed === 1"
            />
        ...
        <div class="monday_times cmonday_times" v-show="!portal.mon_closed">
          <div class="openclose">
            ...
            <input
              class="timepicker tp-open"
              id="m_open"
              width="100"
              readonly
              name="mon_open"
              v-model="portal.mon_open"
              v-timepicker="'mon_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              class="timepicker tp-close"
              id="m_close"
              width="100"
              readonly
              name="mon_close"
              v-model="portal.mon_close"
              v-timepicker="'mon_close'"
            />
          </div>
        </div>
      </div>
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="tuesday_times"
              name="tue_closed"
              @change="openPortal('tuesday')"
              :checked="portal.tue_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              name="tue_closed"
              id="ctuesday_times"
              @change="closePortal('tuesday')"
              :checked="portal.tue_closed === 1"
            />
        ...
        <div class="tuesday_times ctuesday_times" v-show="!portal.tue_closed">
          <div class="openclose">
            ...
            <input
              ...
              readonly
              name="tue_open"
              v-model="portal.tue_open"
              v-timepicker="'tue_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              ...
              readonly
              name="tue_close"
              v-model="portal.tue_close"
              v-timepicker="'tue_close'"
            />
          </div>
        </div>
      </div>
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="wednesday_times"
              name="wed_closed"
              @change="openPortal('wednesday')"
              :checked="portal.wed_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              name="wed_closed"
              id="cwednesday_times"
              @change="closePortal('wednesday')"
              :checked="portal.wed_closed === 1"
            />
        ...
        <div class="wednesday_times cwednesday_times" v-show="!portal.wed_closed">
          <div class="openclose">
            ...
            <input
              ...
              readonly
              name="wed_open"
              v-model="portal.wed_open"
              v-timepicker="'wed_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              ...
              readonly
              name="wed_close"
              v-model="portal.wed_close"
              v-timepicker="'wed_close'"
            />
          </div>
        </div>
      </div>
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="thursday_times"
              name="thu_closed"
              @change="openPortal('thursday')"
              :checked="portal.thu_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              name="thu_closed"
              id="cthursday_times"
              @change="closePortal('thursday')"
              :checked="portal.thu_closed === 1"
            />
        ...
        <div class="thursday_times cthursday_times" v-show="!portal.thu_closed">
          <div class="openclose">
            ...
            <input
              ...
              readonly
              name="thu_open"
              v-model="portal.thu_open"
              v-timepicker="'thu_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              ...
              readonly
              name="thu_close"
              v-model="portal.thu_close"
              v-timepicker="'thu_close'"
            />
          </div>
        </div>
      </div>
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="friday_times"
              name="fri_closed"
              @change="openPortal('friday')"
              :checked="portal.fri_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              name="fri_closed"
              id="cfriday_times"
              @change="closePortal('friday')"
              :checked="portal.fri_closed === 1"
            />
        ...
        <div class="friday_times cfriday_times" v-show="!portal.fri_closed">
          <div class="openclose">
            ...
            <input
              ...
              readonly
              name="fri_open"
              v-model="portal.fri_open"
              v-timepicker="'fri_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              ...
              readonly
              name="fri_close"
              v-model="portal.fri_close"
              v-timepicker="'fri_close'"
            />
          </div>
        </div>
      </div>
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="saturday_times"
              name="sat_closed"
              @change="openPortal('saturday')"
              :checked="portal.sat_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              name="sat_closed"
              id="csaturday_times"
              @change="closePortal('saturday')"
              :checked="portal.sat_closed === 1"
            />
        ...
        <div class="saturday_times csaturday_times" v-show="!portal.sat_closed">
          <div class="openclose">
            ...
            <input
              ...
              readonly
              name="sat_open"
              v-model="portal.sat_open"
              v-timepicker="'sat_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              ...
              readonly
              name="sat_close"
              v-model="portal.sat_close"
              v-timepicker="'sat_close'"
            />
          </div>
        </div>
      </div>
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              id="sunday_times"
              name="sun_closed"
              @change="openPortal('sunday')"
              :checked="portal.sun_closed === 2"
            />
        ...
        <div class="custom-check d-flex">
          <div class="round mr-1">
            ...
            <input
              ...
              name="sun_closed"
              id="csunday_times"
              @change="closePortal('sunday')"
              :checked="portal.sun_closed === 1"
            />
        ...
        <div class="sunday_times csunday_times" v-show="!portal.sun_closed">
          <div class="openclose">
            ...
            <input
              ...
              readonly
              name="sun_open"
              v-model="portal.sun_open"
              v-timepicker="'sun_open'"
            />
          </div>
          <div class="openclose">
            <span class="label">Closed :</span>
            <input
              ...
              readonly
              name="sun_close"
              v-model="portal.sun_close"
              v-timepicker="'sun_close'"
            />
          </div>
        </div>
      </div>
      ...
      <div class="custom-check d-flex">
        ...
        <label class="ml-2 text-white" for="terms_condition">Accept</label
        ><a
          href="javascript:;"
          style="color: #efa720; font-size: 16px; margin-left: 4px"
          data-toggle="modal"
          data-target="#user_agreement_modal"
          >User Agreement</a
        >
      </div>
  ...
  methods: {
    ...
    async savePortal() {
      ...
      if (data.status == 200) {
        ...
        const {
          data: { token },
        } = await this.axios.post('/login', { username: this.portal.username, password: this.portal.password })
        // Save the token.
    ...
    makeInitialTextReadOnly(input) {
      ...
      input.addEventListener('keydown', function (event) {
        ...
        if (
          (which == 8 && input.selectionStart <= readOnlyLength) ||
