          ...
          <div class="row">
            <div class="col-md-12">
              <div class="forum_header">
                <img
                  src="/imgs/h_icon4.png"
                  width="35"
                  style="margin-top: -8px; margin-right: 3px"
                  alt="Marijuana Forums"
                />
                ...
                <div class="forum_button">
                  <div class="forum_button_area">
                    <ul>
                      <li class="dropdown">
                        <button
                          class="btn_forum_search dropdown-toggle"
                        ...
                        <div class="search_input dropdown-menu">
                          <button type="button" class="btn_times" @click="searchTimes()">
                        ...
                        <div class="select_input text-center" v-show="this.selectbox">
                          ...
                          <div class="nav_body">
                            ...
                            <div v-show="showCategories">
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa>&nbsp;&nbsp;Stoner's
                                Lounge
                              </p>
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa>&nbsp;&nbsp;Concentrates
                              </p>
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa>&nbsp;&nbsp;Edibles
                              </p>
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa
                                >&nbsp;&nbsp;Indoor/Outdoor Grow
                              </p>
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa
                              ...
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa>&nbsp;&nbsp;CBD/THC
                              </p>
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa>&nbsp;&nbsp;Marijuana
                                News
                              </p>
                              <p class="forum_category">
                                <fa :icon="['far', 'dot-circle']" class="main-color fs-10"></fa>&nbsp;&nbsp;Advertise
                              </p>
                            </div>
                            <div v-show="showTopics">
                              <p class="limittextlength" v-for="item in curtopic.usertopics" :key="item.id">
                                ...
                                <a
                                  v-else
                                  :href="'/marijuana-forums/' + item.get_m_parent.title + '/' + item.get_m_parent.id"
                                >
                                  <span class="col-blue">Reply:</span>
                                  <span v-if="item.get_m_parent.title" class="bookmarktitle">{{
                                    item.get_m_parent.title
                                  }}</span>
                                </a>
                              </p>
                            </div>
                    ...
                    <div
                      class="custom_modal_back"
                      id="custom_modal_back"
                      @click="hiddenmodal()"
                      v-show="this.selectbox"
                    ></div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="btn_area">
              ...
              <div class="forum_topic">
                <button @click="newtopictoggle()" class="btn_forum_topic new_topic">
                  <span><fa icon="plus" fixed-width></fa></span> New Topic
                </button>
              </div>
            </div>
            ...
            <div class="cur_forum" v-show="loaded">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="javascript:;" @click="viewCategoryForums(forum.category)">{{ forum.category }}</a>
                </li>
                ...
                <div class="topic-avatar">
                  ...
                  >
                    <img
                      ...
                      width="45"
                      height="45"
                      :src="serverUrl(forum.user.profile_pic ? forum.user.profile_pic.url : '/imgs/default_sm.png')"
                      class="avatar"
                    />
                  </a>
                ...
                <div class="topic-body">
                  <div class="topic-meta-data">
                    ...
                    <div class="post-infos">
                      <span :title="forum.created_at" data-time="" data-format="" class="relative-date">{{
                        forum.created_at | moment('from', curtopic.curtime, true)
                      }}</span>
                    </div>
                  </div>
                  <div style="clear: both"></div>
                  ...
                  <div class="post-menu-area">
                    <div class="topic_action">
                      <div>
                        <ul>
                          <li>
                            <button class="btn-transparent btn_like_num" v-show="forum.likes.length">
                              {{ forum.likes.length }}
                            </button>
                            <button
                              class="btn-transparent btn_like_topic"
                              :data-topic-id="forum.id"
                              :data-liked="is_like(curtopic.curforum.likeslist)"
                              @click="changelike(forum, 'main')"
                            >
                              <fa
                                v-if="is_like(curtopic.curforum.likeslist)"
                                icon="heart"
                                class="main-color"
                                fixed-width
                              ></fa>
                            ...
                            <button class="btn-transparent btn_bookmark" @click="changebookmark(forum)">
                              <fa
                                v-if="curtopic.curforum.bookmarked"
                                icon="bookmark"
                                class="main-color"
                                fixed-width
                              ></fa>
                            ...
                            &nbsp;
                            <div
                              v-if="auth_user && (auth_user.id == forum.user_id || isAdmin || auth_user.id === 1)"
                              style="display: inline-block"
                              class="dropdown"
                            >
                              <button
                                class="btn-transparent btn_edit dropdown-toggle"
                                data-toggle="dropdown"
                                @click="editConfirmModal(forum.id, forum.mparent)"
                              >
                                <fa icon="edit"></fa>
                              </button>
                              <ul class="dropdownEdit dropdown-menu">
                                <li>
                                  <button slot="button" class="btn_modal_edit mr-20" v-on:click="showEdit()">
                                    Edit
                                  </button>
                                </li>
                                <li>
                          ...
                          <li>
                            <button
                              class="btn_topic_reply"
                              data-topic-id=""
                              @click="toggle(forum.user_id)"
              ...
              <div class="reply_list">
                <div
                  class="reply_item"
                  :id="'topic_id_' + item.id"
                  :ref="'topic_id_' + item.id"
                  v-for="item in curtopic.replies"
                  :key="item.id"
                >
                  <div
                    class="original_topic"
                    :id="'embeddedID_' + item.id"
                    :ref="'embeddedID_' + item.id"
                    v-if="item.sParent_user"
                    v-show="hidden_id == item.id"
                  >
                    <section class="embedded-posts top">
                      <button
                        @click="collapse()"
                        class="widget-button btn btn collapse-down no-text btn-icon"
                        aria-label="collapse"
                        title="collapse"
                      >
                            ...
                            <div class="topic-avatar">
                              ...
                              >
                                <img
                                  ...
                                  :src="
                                    serverUrl(
                                      item.sParent_user.profile_pic
                                        ? item.sParent_user.profile_pic.url
                                        : '/imgs/default_sm.png'
                                    )
                                  "
                                  :title="item.sParent_user.name"
                                  class="avatar"
                                />
                              </a>
                              <a
                              ...
                              <div class="topic-meta-data">
                                <div class="names trigger-user-card">
                                  <span class="first username">
                                    <a
                                      v-if="item.sParent_user"
                                      :href="'/' + item.sParent_user.name"
                                      :data-user-card="item.sParent_user.name"
                                    >
                                      <img
                                        v-if="forum.user"
                                        alt=""
                                        ...
                                        :src="
                                          serverUrl(
                                            forum.user.profile_pic ? forum.user.profile_pic.url : '/imgs/default_sm.png'
                                          )
                                        "
                                        title=""
                                        class="mo_show avatar"
                                ...
                                <div class="post-link-arrow">
                                  <a
                                    ...
                                    @click="showselectedTopic(item.get_s_parent.id)"
                                    title="jump to earlier reply"
                                  >
                  ...
                  <div class="reply_body">
                    <div class="topic-avatar">
                      ...
                      >
                        <img
                          ...
                          width="45"
                          height="45"
                          :src="serverUrl(item.user.profile_pic ? item.user.profile_pic.url : '/imgs/default_sm.png')"
                          title=""
                          class="avatar"
                        />
                      </a>
                    ...
                    <div class="topic-body">
                      <div class="topic-meta-data">
                        <div class="names">
                          <a v-if="item.user" :href="'/' + item.user.name">
                            <img
                              ...
                              height="45"
                              :src="
                                serverUrl(item.user.profile_pic ? item.user.profile_pic.url : '/imgs/default_sm.png')
                              "
                              title=""
                              class="mo_show avatar"
                            />
                            <span class="mo_lh45 username"> {{ item.user.name }}</span>
                          </a>
                          <a v-else href="javascript:void(0);">
                            <img
                              alt=""
                        ...
                        <div class="post-infos">
                          <button
                            class="mr-20 btn-trans"
                            @click="showEmbeded(item.id)"
                          ...
                          <span :title="item.created_at" data-time="" data-format="" class="relative-date">{{
                            item.created_at | moment('from', curtopic.curtime, true)
                          }}</span>
                        </div>
                      </div>
                      <div style="clear: both"></div>
                      ...
                      <div class="post-menu-area">
                        <button
                          class="btn_topic_reply"
                          :data-topic-id="item.id"
                          @click="showSEmbeded(item.id)"
                          v-if="item.schildren.length"
                        >
                          {{ item.schildren.length }} Replies <fa icon="chevron-down"></fa>
                        </button>
                        <div class="topic_action">
                          <ul>
                            <li>
                              <button
                                class="btn-transparent btn_like_num"
                                :title="item.likes + 'people liked this post'"
                                v-show="item.likes.length"
                              >
                                {{ item.likes.length }}
                              </button>
                              <button
                                class="btn-transparent btn_like_topic"
                                :data-topic-id="item.id"
                                :data-liked="is_like(item.likeslist)"
                                @click="changelike(item, 'reply')"
                              >
                              ...
                              &nbsp;
                              <div
                                v-if="auth_user && (auth_user.id == item.user_id || isAdmin || auth_user.id === 1)"
                                class="dropdown"
                                style="display: inline-block"
                              >
                                <button
                                  ...
                                  data-toggle="dropdown"
                                  @click="editConfirmModal(item.id, item.mparent)"
                                >
                                  <fa icon="edit"></fa>
                                </button>
                                <ul class="dropdownEdit dropdown-menu">
                                  ...
                                  <li>
                                    <button slot="button" class="btn_modal_delete" @click="deleteTopic()">
                                      Delete
                                    </button>
                                  </li>
                                </ul>
                      ...
                      <section
                        ...
                        v-show="Shidden_id == item.id"
                        v-if="item.schildrens.length"
                      >
                        <button
                          @click="Scollapse()"
                          class="widget-button btn btn collapse-up no-text btn-icon"
                          aria-label="collapse"
                          title="collapse"
                        >
                        ...
                        <div data-post-id="" v-for="sitem in item.schildrens" :key="sitem.id" class="reply">
                          <div class="topic-avatar">
                            ...
                            >
                              <img
                                ...
                                :src="
                                  serverUrl(
                                    sitem.user.profile_pic ? sitem.user.profile_pic.url : '/imgs/default_sm.png'
                                  )
                                "
                                :title="sitem.user.name"
                                class="avatar"
                              />
                            </a>
                            <a
                          ...
                          <div class="topic-body">
                            <div class="topic-meta-data">
                              ...
                              <div class="post-link-arrow">
                                <button
                                  class="post-info arrow btn-trans"
                                  @click="showselectedTopic(item.schildrens[item.schildrens.length - 1].id)"
                                  title="jump to later reply"
                                >
            ...
            <div class="editorsection">
              <div v-show="this.createEditStatus">
                <div>
                  <span class="fs-20" style="color: #fefefe">
                    ...
                    <img
                      ...
                      height="40"
                      class="radius50"
                      :src="serverUrl(this.topicUser.pic ? this.topicUser.pic : 'imgs/default_sm.png')"
                    />
                ...
                <div v-if="errors.length">
                  <ul>
                    <li
                      style="display: inline-block; color: red; font-family: Arial"
        ...
        this.axios.post(uri, this.topic).then((response) => {
          ...
          if (this.auth_user.id != topic_user_id) {
            let noti_fb = firebase
              .database()
              .ref('notifications/' + topic_user_id)
              .push()
            noti_fb.set({
