<template>
  <div :class="{ 'mt-2': !is_edit }">
    <div class="pa_addform border-0" :class="{ pa_mobile: $device.isMobile }">
      <div
        class="sticky-top strains__sticky"
        style="
          margin-right: -12px;
          margin-left: -12px;
          background: #fff;
      ...
      <div class="pa-logo">
        ...
        <img
          :src="brand_form.is_active ? '/imgs/active.png' : '/imgs/inactive.png'"
          alt=" "
          class="btn-power"
          v-if="is_edit && brand_form"
          @click="openActivatePopup = true"
        />
      </div>
      ...
      <form
        ...
        method="post"
        ref="pa_addform"
        @submit="is_edit ? update($event) : save($event)"
      >
        ...
        <div class="floating-label mt-4">
          <input
            ...
            required
            autocomplete="off"
            v-model="brand_form.email"
            placeholder=" "
          />
          <label for="portal_email">Brand Email *</label>
        </div>
        <div
          class="form-label-group portal_description floating-portal floating-label mt-4"
        ...
        >
          <textarea
            ...
            placeholder=" "
            v-model="brand_form.description"
          ></textarea>
        ...
        <div class="floating-label mt-2">
          <input
            ...
            id="website"
            data-value="http://"
            v-model="brand_form.website_url"
            placeholder=" "
          />
        ...
        <div class="floating-label">
          <input
            ...
            name="facebook_url"
            id="facebook"
            v-model="brand_form.facebook_url"
        ...
        <div class="floating-label">
          <input
            ...
            name="twitter_url"
            id="twitter"
            v-model="brand_form.twitter_url"
        ...
        <div class="floating-label">
          <input
            ...
            name="instagram_url"
            id="instagram"
            v-model="brand_form.instagram_url"
        ...
        <div class="floating-label">
          <input
            ...
            name="youtube_url"
            id="youtube"
            v-model="brand_form.youtube_url"
  ...
  methods: {
    ...
    async save(event) {
      ...
      if (data.status == 200) {
        ...
        const {
          data: { token },
        } = await this.axios.post('/login', { username: this.brand_form.username, password: this.brand_form.password })
        // Save the token.
