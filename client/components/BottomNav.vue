          ...
          <ul class="footer_tollbar">
            ...
            <li>
              <a href="javascript:;" @click="openMessenger()">
                ...
                <span
                  v-if="user"
                  class="badge badge-pill badge-success messenger-unread"
                  style="position: absolute; top: 5px"
                  >{{ message_count == 0 ? '' : message_count }}</span
                >
                <p>Messenger</p>
              </a>
            </li>
            ...
            <li>
              <a href="javascript:;" @click="goNotification()">
                ...
                <span
                  ...
                  class="badge badge-pill badge-success notification-unread"
                  style="position: absolute; top: 5px"
            ...
            <li class="myaccount">
              <a v-if="user" href="javascript:;" @click="goProfile()">
                <img
                  :src="serverUrl(user.profile_pic ? user.profile_pic.url : '/imgs/default_sm.png')"
                  style="padding: 5px; border-radius: 100px; object-fit: cover"
                  alt=""
                />
                <p>Account</p>
              </a>
